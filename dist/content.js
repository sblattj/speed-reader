...
/* display:flex above beats the UA [hidden] rule; without this the empty
   grid keeps its 25ch in the row and shoves chunk size 2/3 off center. */
.pivot-grid[hidden] { display: none; }
.pivot-cell {
  white-space: nowrap;
  overflow: visible;
}
